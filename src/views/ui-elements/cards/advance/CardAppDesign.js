  ...
  return (
    <Card className='card-app-design'>
      <CardBody>
        ...
        <CardTitle className='mt-1 mb-75'>Core members</CardTitle>
        <CardText className='font-small-2 mb-2'>
          The team which happily spends their valuable time to run this society smoothly
        </CardText>
        <div className='design-group mb-2 pt-50'>
          ...
          <Badge color='light-primary'>Wellfare</Badge>
        </div>
